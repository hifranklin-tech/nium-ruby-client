...
# Unit tests for NiumClient::IndividualCustomerResponseDTO
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NiumClient::IndividualCustomerResponseDTO do
  let(:instance) { NiumClient::IndividualCustomerResponseDTO.new }

  describe 'test an instance of IndividualCustomerResponseDTO' do
    it 'should create an instance of IndividualCustomerResponseDTO' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NiumClient::IndividualCustomerResponseDTO)
    end
  end
