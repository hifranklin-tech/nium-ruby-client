...
# Unit tests for NiumClient::Pagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NiumClient::Pagination do
  let(:instance) { NiumClient::Pagination.new }

  describe 'test an instance of Pagination' do
    it 'should create an instance of Pagination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NiumClient::Pagination)
    end
  end
