...
# Unit tests for NiumClient::ApplicantDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NiumClient::ApplicantDetails do
  let(:instance) { NiumClient::ApplicantDetails.new }

  describe 'test an instance of ApplicantDetails' do
    it 'should create an instance of ApplicantDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NiumClient::ApplicantDetails)
    end
  end
