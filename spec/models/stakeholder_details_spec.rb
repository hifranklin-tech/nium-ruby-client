...
# Unit tests for NiumClient::StakeholderDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NiumClient::StakeholderDetails do
  let(:instance) { NiumClient::StakeholderDetails.new }

  describe 'test an instance of StakeholderDetails' do
    it 'should create an instance of StakeholderDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NiumClient::StakeholderDetails)
    end
  end
