...
# Unit tests for NiumClient::AddCardRequestV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NiumClient::AddCardRequestV2 do
  let(:instance) { NiumClient::AddCardRequestV2.new }

  describe 'test an instance of AddCardRequestV2' do
    it 'should create an instance of AddCardRequestV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NiumClient::AddCardRequestV2)
    end
  end
