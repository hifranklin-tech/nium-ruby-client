...
# Unit tests for NiumClient::BankTransfer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NiumClient::BankTransfer do
  let(:instance) { NiumClient::BankTransfer.new }

  describe 'test an instance of BankTransfer' do
    it 'should create an instance of BankTransfer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NiumClient::BankTransfer)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["bankTransfer"])
