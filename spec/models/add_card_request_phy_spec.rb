...
# Unit tests for NiumClient::AddCardRequestPHY
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NiumClient::AddCardRequestPHY do
  let(:instance) { NiumClient::AddCardRequestPHY.new }

  describe 'test an instance of AddCardRequestPHY' do
    it 'should create an instance of AddCardRequestPHY' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NiumClient::AddCardRequestPHY)
    end
  end
