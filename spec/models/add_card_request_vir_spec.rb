...
# Unit tests for NiumClient::AddCardRequestVIR
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NiumClient::AddCardRequestVIR do
  let(:instance) { NiumClient::AddCardRequestVIR.new }

  describe 'test an instance of AddCardRequestVIR' do
    it 'should create an instance of AddCardRequestVIR' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NiumClient::AddCardRequestVIR)
    end
  end
