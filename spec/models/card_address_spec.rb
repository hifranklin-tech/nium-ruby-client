...
# Unit tests for NiumClient::CardAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NiumClient::CardAddress do
  let(:instance) { NiumClient::CardAddress.new }

  describe 'test an instance of CardAddress' do
    it 'should create an instance of CardAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NiumClient::CardAddress)
    end
  end
