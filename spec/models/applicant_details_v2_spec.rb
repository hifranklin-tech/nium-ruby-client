...
# Unit tests for NiumClient::ApplicantDetailsV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NiumClient::ApplicantDetailsV2 do
  let(:instance) { NiumClient::ApplicantDetailsV2.new }

  describe 'test an instance of ApplicantDetailsV2' do
    it 'should create an instance of ApplicantDetailsV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NiumClient::ApplicantDetailsV2)
    end
  end
