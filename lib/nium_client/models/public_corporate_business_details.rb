...
module NiumClient
  class PublicCorporateBusinessDetails
    ...
    attr_accessor :search_reference_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NiumClient::PublicCorporateBusinessDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NiumClient::PublicCorporateBusinessDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'search_reference_id')
        self.search_reference_id = attributes[:'search_reference_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          search_reference_id == o.search_reference_id &&
          website == o.website
    end
    ...
    def hash
      [addresses, business_name, business_registration_number, business_type, search_reference_id, website].hash
    end
