  ...
  class ApplicantDetailsV2
    ...
    def self.openapi_types
      {
        ...
        :'contact_details' => :'ContactDetailsResponseDTO',
        ...
        :'nationality' => :'String',
        :'occupation' => :'String',
        :'professional_details' => :'Array<ProfessionalDetailsResponseDTO>',
        :'reference_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NiumClient::ApplicantDetailsV2` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NiumClient::ApplicantDetailsV2`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_resident')
        self.is_resident = attributes[:'is_resident']
      end
    ...
    def hash
      [address, birth_country, contact_details, date_of_birth, document_details, first_name, gender, is_pep, is_resident, last_name, middle_name, nationality, occupation, professional_details, reference_id, tax_details].hash
    end
