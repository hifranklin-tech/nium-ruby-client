...
module NiumClient
  ...
  class BlockAndReplaceCardRequestDTO
    ...
    attr_accessor :use_current_address
    ...
    def self.attribute_map
      {
        ...
        :'use_current_address' => :'useCurrentAddress',
        :'delivery' => :'delivery',
        :'email' => :'email',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NiumClient::BlockAndReplaceCardRequestDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NiumClient::BlockAndReplaceCardRequestDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'replace_card')
        self.replace_card = attributes[:'replace_card']
      else
        self.replace_card = nil
      end
      ...
      if attributes.key?(:'use_current_address')
        self.use_current_address = attributes[:'use_current_address']
      end
    ...
    def list_invalid_properties
      ...
      if @replace_card.nil?
        invalid_properties.push('invalid value for "replace_card", replace_card cannot be nil.')
      end
    ...
    def valid?
      ...
      reason_validator = EnumAttributeValidator.new('String', ["fraud, lost, stolen, damaged"])
      return false unless reason_validator.valid?(@reason)
      return false if @replace_card.nil?
    ...
    def reason=(reason)
      validator = EnumAttributeValidator.new('String', ["fraud, lost, stolen, damaged"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          reason == o.reason &&
          replace_card == o.replace_card &&
          plastic_id == o.plastic_id &&
          card_expiry == o.card_expiry &&
          use_current_address == o.use_current_address &&
          delivery == o.delivery &&
          email == o.email &&
    ...
    def hash
      [reason, replace_card, plastic_id, card_expiry, use_current_address, delivery, email, country_code, mobile].hash
    end
