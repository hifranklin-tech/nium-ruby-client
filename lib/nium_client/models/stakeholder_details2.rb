...
module NiumClient
  class StakeholderDetails2
    ...
    attr_accessor :is_primary_applicant
    ...
    def self.attribute_map
      {
        ...
        :'gender' => :'gender',
        :'is_primary_applicant' => :'isPrimaryApplicant',
        :'last_name' => :'lastName',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NiumClient::StakeholderDetails2` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NiumClient::StakeholderDetails2`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_primary_applicant')
        self.is_primary_applicant = attributes[:'is_primary_applicant']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gender == o.gender &&
          is_primary_applicant == o.is_primary_applicant &&
    ...
    def hash
      [additional_info, address, birth_country, contact_details, date_of_birth, document_details, first_name, gender, is_primary_applicant, last_name, middle_name, nationality, professional_details, source_of_funds, tax_details, title].hash
    end
